    ...
    <div>
      ...
      <section className="relative bg-navy min-h-[90vh] flex items-center overflow-hidden">
        ...
        <div className="absolute inset-0" style={{
          backgroundImage: 'radial-gradient(circle at 30% 70%, rgba(59,130,246,0.15) 0%, transparent 50%), radial-gradient(circle at 70% 30%, rgba(245,158,11,0.1) 0%, transparent 50%)'
        }} />
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 text-center">
          <ScrollFadeIn>
            <div className="flex items-center justify-center gap-3 mb-6">
              <Zap className="w-10 h-10 sm:w-12 sm:h-12 text-gold" />
            </div>
            <h1 className="text-4xl sm:text-6xl lg:text-7xl font-extrabold text-white leading-tight mb-4">
              WorkWave<br />
              <span className="text-gold">Amplify</span> 2027
            </h1>
          </ScrollFadeIn>
          ...
          <ScrollFadeIn delay={300}>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <a
                ...
                className="bg-gold hover:bg-gold-dark text-navy font-bold px-8 py-4 rounded-lg text-lg transition-colors inline-flex items-center gap-2"
              >
            ...
            {stats.map((stat, i) => (
              <ScrollFadeIn key={stat.label} delay={i * 100}>
                <div className="text-center">
                  <div className="text-4xl sm:text-5xl font-extrabold text-navy mb-1">{stat.value}</div>
      ...
      <section className="bg-gray-50 py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <ScrollFadeIn>
            <h2 className="text-3xl sm:text-4xl font-bold text-navy text-center mb-12">Why Attend?</h2>
          </ScrollFadeIn>
      ...
      <section className="bg-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <ScrollFadeIn>
            <h2 className="text-3xl sm:text-4xl font-bold text-navy text-center mb-4">Hot Topics This Year</h2>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <ScrollFadeIn>
            <div className="flex items-center justify-between mb-8">
              <h2 className="text-3xl sm:text-4xl font-bold text-navy">Featured Sessions</h2>
